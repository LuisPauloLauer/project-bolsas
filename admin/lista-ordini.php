...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
        <h1>Lista ordini con paypal pagati non inviati</h1>
			<table class="table table-striped">
				...
				<?php
					...
					$query 		= "SELECT * FROM ordini WHERE stato='si' AND inviato='no' AND tipo='paypal' ORDER BY id DESC";
				...
				<tr>
                    ...
                    <td>€</td>
					<td class="text-center"><a href="edit-ordine.php?id=<?php echo $ordine['id'] ?>" title="Modifica"><span class="glyphicon glyphicon-edit"></span></a></td>
